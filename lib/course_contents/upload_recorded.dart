...
class UploadRecorded extends StatefulWidget {
  ...
  @override
  State<UploadRecorded> createState() => _UploadRecordedState();
}

class _UploadRecordedState extends State<UploadRecorded> {
  String timeText = "";
  String dateText = "";
