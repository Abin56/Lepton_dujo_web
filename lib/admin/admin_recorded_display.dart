...
class AdminRecordedDisplay extends StatefulWidget {
  ...
  @override
  State<AdminRecordedDisplay> createState() => _AdminRecordedDisplayState();
}

class _AdminRecordedDisplayState extends State<AdminRecordedDisplay> {
  String timeText = "";
  String dateText = "";
  ...
  CollectionReference refRecorded =
      FirebaseFirestore.instance.collection("RecordedCourseDetails");
