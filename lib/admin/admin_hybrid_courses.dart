...
class AdminHybrid extends StatefulWidget {
  ...
  @override
  State<AdminHybrid> createState() => _AdminHybridState();
}

class _AdminHybridState extends State<AdminHybrid> {
  String name = "";
